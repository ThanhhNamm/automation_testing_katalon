...
class authentication {
	...
	def verify_page_title_visible(String pageTitle) {
		WebUI.waitForElementVisible(findTestObject('Object Repository/000_Common/h2_GeneralText',['param':pageTitle]), GlobalVariable.MIN_TIME_FOR_WAIT)
		WebUI.verifyElementVisible(findTestObject('Object Repository/000_Common/h2_GeneralText',['param':pageTitle]))
	}


	@When("I enter data below into {string} and {string} fields of Signup")
	def enter_data_into_field(String namePlaceholder, String emailPlaceholder, DataTable data) {
		List<String> dataInput = data.asList()
		WebUI.sendKeys(findTestObject('Object Repository/000_Common/input_GetByPlaceholder',['param':namePlaceholder]),dataInput[0])
		WebUI.sendKeys(findTestObject('Object Repository/000_Common/input_GetByPlaceholder',['param':emailPlaceholder]),dataInput[1])
	}
}